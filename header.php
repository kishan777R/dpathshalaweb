...
?>
	<script>
		var affif = "<?php echo $_GET['aff']; ?>";
		if (localStorage.getItem("website_aff_id") && localStorage.getItem("website_aff_id") == affif) {

		} else {
			localStorage.setItem("website_aff_id", "<?php echo $_GET['aff']; ?>");
			localStorage.setItem("add_aff_in_order", "YES");

			saveUniqueVisitorOfAffilator(affif, "website");
		}

		function saveUniqueVisitorOfAffilator(affif, course_id) {
			...
			xhttp.open("POST", apiurl + "api/saveUniqueVisitorOfAffilator", true);
			xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xhttp.send("aff_id=" + affif + "&course_id=" + course_id);
		}
	</script>
...
$pos = strpos($url, 'course');
if ($pos === false) {
} else {
	$forcoursedetailpageonly = "  cs-courses-detail";
}

$posaffiliatelogin = strpos($url, 'affiliatelogin');
$posaffiliateLink = strpos($url, 'affiliatelink');
$posaffiliateRegistartion = strpos($url, 'affiliateregistration');
...
<body class="wp-smartstudy <?php echo $forcoursedetailpageonly; ?>" oncontextmenu="return false;" oncopy="<?php if ($posaffiliateLink) {
																												echo "";
																											} else {
																												echo "return false";
																											} ?>" oncut="return false" onpaste="return false" id="bodyid">
	<div class="wrapper">
		<!-- Side Menu Start -->
		<div id="overlay"></div>
									...
									<ul style="float:right"> <?php
												...
												<li>
													...
													<ul style="width:270px;left:-72px;right:0">
														...
														<?php
																		if ($newNoti > 0) {
														?> <li><a href="<?php echo $server; ?>notifications" style="color:#333333 !important"> See All</a></li>
														<?php } else {
												...
												<div class="cs-user-login">
													<div class="cs-media">
														<figure>
															...
															?>
																<img alt="" src="<?php echo $server; ?>assets/images/avatar.png" id="profilepicsrcHeader">
															<?php
															}
															?>
														</figure>
													...
													<a href="#">
														...
														if ($_SESSION['login_user_type'] == 'AFFILIATE' or $_SESSION['login_user_type'] == 'STUDENT') {
															...
															echo "To Do" . " (" . $_SESSION['login_user_type'] . ")";
														}
													...
													<ul>
														...
														?>
															...
															<li class=""><a href="<?php echo $server; ?>profile"><i class="icon-person"></i> Profile </a></li>
														...
														if ($_SESSION['login_user_type'] == 'TEACHER') {
															...
															?><li><a href="user-detail.html"><i class="icon-user3"></i> About me</a></li>
																...
																<li class=""><a href="<?php echo $server; ?>logout"><i class="icon-login"></i> Logout </a></li>
															<?php
															} else {
															?> <li><a href="<?php echo $server; ?>profilecomplete">Profile </a></li>
																<li class=""><a href="<?php echo $server; ?>logout"><i class="icon-login"></i> Logout </a></li>
															<?php
															}
														} else if ($_SESSION['login_user_type'] == 'STUDENT') {
															?>
															<li><a href="<?php echo $server; ?>studentcourses"><i class="icon-graduation-cap"></i> My Courses</a></li>

															<li><a href="<?php echo $server; ?>usersummary"><i class="icon-text-document"></i> Statement</a></li>
															<li><a href="<?php echo $server; ?>studentbankingdetails"><i class="icon-bank"></i> Banking</a></li>

														<?php
														}
														if ($_SESSION['login_user_type'] == 'AFFILIATE' or $_SESSION['login_user_type'] == 'STUDENT') {
														?>
															<li class=""><a href="<?php echo $server; ?>affiliatestats"><i class="icon-chart"></i> Affiliate Stats </a></li>
															<li class=""><a href="<?php echo $server; ?>affiliatelink"><i class="icon-link"></i> Affiliate Links </a></li>
												...
												<div class="modal-body">
													...
													<div class="cs-login-form">
														<form onsubmit="event.preventDefault(); registerMe();" id="R">
															<div class="input-holder">
																<label id="first_namelabel" for="cs-username">
																	...
																	<input type="text" class="" id="first_name" placeholder="Type desired name">
																</label>
															</div>
															<!-- <div class="input-holder">
														...
														<script>
															...
															function saveloginsession(wherenow, login_user_type) {


																var xhttp = new XMLHttpRequest();
																xhttp.onreadystatechange = function() {
																	if (this.readyState == 4 && this.status == 200) {
																		var stvr = window.location.href;

																		var n = stvr.search("checkout");
																		if (n > -1) {
																...
																xhttp.open("POST", "<?php echo $server; ?>insideapi.php", true);
																xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
																newclient.profile_verified = true;
																xhttp.send("login_user_type=" + login_user_type + "&key=saveloginclientdetails&clientdata=" + JSON.stringify(newclient));
															}
															...
															function registerMe() {
																...
																xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
																xhttp.send("first_name=" + first_name + "&his_affilitater_c_id_int=" + his_affilitater_c_id_int + "&login_user_type=STUDENT" + "&last_name=" + last_name + "&email=" + email.toLowerCase() + "&mobile=" + mobile + "&password=" + password.toLowerCase() + "&c_password=" + c_password.toLowerCase());
															}
													...
													<div class="cs-login-form">
														...
														<script>
															...
															function loginMe() {
																...
																xhttp.onreadystatechange = function() {
																	if (this.readyState == 4 && this.status == 200) {
																		...
																		if (response.status == 'SUCCESS') {
																			...
																			newclient = response.newclient;
																			saveloginsession('', newclient.login_user_type);
																		} else {
																...
																xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
																xhttp.send("email=" + email.toLowerCase() + "&password=" + password.toLowerCase());
															}
														</script>
													</div>
												</div>
												...
												<div class="modal-body">
													...
													<div class="cs-login-form">
														<form onsubmit="event.preventDefault(); forget();">
															...
															<div class="input-holder">
																<a href="javascript:;" data-toggle="modal" data-target="#cs-login" style="float:right;color:#207dba !important" data-dismiss="modal" class="cs-color" aria-hidden="true">Login Now</a>
														...
														<script>
															...
															function forget() {
																...
																xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
																xhttp.send("email=" + email.toLowerCase());
															}
														</script>
													</div>
												</div>
							...
							<div class="col-lg-10 col-md-10 col-sm-6 col-xs-6">
								<div class="cs-main-nav pull-right">
									<nav class="main-navigation">
										<ul>
											<li class="menu-item">
												<a href="<?php echo $server; ?>">Home</a><span>
													<!--<?php echo $website; ?></span>-->

											</li>
											<li class="menu-item"><a href="<?php echo $server; ?>courses?category=Digital%20Products"> Digital Products</a>
												<!-- <span>Online Education</span> -->

											</li>
											<li class="menu-item"><a href="<?php echo $server; ?>courses?category=Courses">Courses </a>
												<!-- <span>Online Education</span> -->

											</li>
											
											<li class="menu-item"><a href="<?php echo $server; ?>about-us">About Us</a>
												<!-- <span>About <?php echo $website; ?></span> -->

											</li>
											
											<li class="menu-item"><a href="<?php echo $server; ?>contact-us">Contact Us</a>
												<!-- <span>Inquire with us</span> -->

											</li>
											<li class="menu-item-has-children" style="display:none;"><a href="#">Others</a><span>All you need</span>
												<ul>
													<li><a href="user-detail.html">Student Dashboard</a></li>
													<li><a href="instructor-detail.html">instructor Dashboard</a></li>
													<li><a href="affiliations.html">Affiliations</a></li>
											...
											<li class="cs-search-area">
												...
												<div class="search-area">
													...
													<form id="formidofcartdivDesktopn" style="background: gray">
												...
												<script>
													function remove(subcourseid) {
														...
														xhttp.open("GET", "<?php echo $server; ?>insideapi.php?sub_course_id=" + subcourseid + "&key=removefromcartJustNumberReturn", true);
														xhttp.send();
												...
												<script>
													...
													function getcartdetails() {
														...
														xhttp.open("GET", "<?php echo $server; ?>insideapi.php?key=cartlistHTML", true);
														xhttp.send();
													}
													...
													function getcartNumber() {
														...
														xhttp.open("GET", "<?php echo $server; ?>insideapi.php?key=cartNumber", true);
														xhttp.send();
													}
												</script>
											</li>
									...
									<div class="cs-search-area hidden-md hidden-lg">
										...
										<div class="search-area">
											<a href="#" onclick="getcartdetails();document.getElementById('formidofSearchdivMobilen').style.display='none'"> <i style="font-size:20px;" class="icon-cart"></i> <span class="badge  btn-danger" id="cartlengthid2">
													...
													?> </span></a>
											<form id="formidofcartdivMobilen " style="background: gray">
