 							...
 							<?php
								...
								?>
 								<div class="cs-user-signup">
 									...
 									<strong>Not a Affiliate yet? </strong>
 									<a href="<?php echo $server;?>affiliateregistration">Signup Now</a>
 								</div>
 							...
 							<?php
								...
								?>
 								<div class="cs-user-signup">
 									...
 									<a href="<?php echo $server;?>registration">Signup Now</a>
 								</div>
 								...
 								xhttp.onreadystatechange = function() {
 									if (this.readyState == 4 && this.status == 200) {
 										...
 										if (response.status == 'SUCCESS') {
 											...
 											if (newclient.login_user_type == 'STUDENT') {
 												saveloginsession('studentcourses', newclient.login_user_type);
 											} else if (newclient.login_user_type == 'AFFILIATE') {
 												saveloginsession('affiliatestats', newclient.login_user_type);
 											}
