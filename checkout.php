								...
								<table border=0 style="width: 99%;margin-top:25px">
									<tr>
										<td style="width: 30%;border:none">
											...
											<img ng-click='rediretctocourse(courseObj)' style="cursor:pointer;height:100%;width:100%" src="{{courseObj.serverpath+courseObj.imagepath}}" alt="" />


										</td>
										<td style="width: 70%;border:none;">

											<strong ng-click='rediretctocourse(courseObj)' style="cursor:pointer;line-height:30px;margin-top:10px;margin-left:25px"> {{courseObj.course_name}}</strong>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-md-8" ng-show="listofSubCourse.length>0" style="float: right">
							...
							<div class="cs-field">
								<div class="cs-btn-submit">
									...
									<?php
									if (isset($_SESSION['login_id'])) {
										if (isset($_SESSION['login_user_type']) and ($_SESSION['login_user_type'] == 'STUDENT' || $_SESSION['login_user_type'] == 'AFFILIATE')) {
									?>
