     ...
     <?php
        ...
        $headers .= 'From: DPATHSHALA SUPPORT<contact@dpathshala.live>' . "\r\n";
        $subject1 = "Message from Website from $email ";


        $message =  "<b>Email :</b> $email<br/><br/><b>Name :</b> $name<br/><br/><b>Phone :</b> $phone<br/><br/><b>Subject :</b> $subject<br/><br/><b>Message :</b> $message ";
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            $mailresponse = maiServerl("kishanrock777@gmail.com", $subject1, $message, $headers, []);
        ...
        function finalEmail($mail, $attachFile, $EmailContactArr, $subject, $msgContent)
        {
            ...
            $staffArr['smtpemail'] = 'kishanrock777@gmail.com';
            $staffArr['password'] = 'kishanrock77@yahoo.com';
            ...
            $mail->SetFrom($staffArr['smtpemail'], 'DPATHSHALA SUPPORT');
            $mail->ClearAddresses();
