...
<div >
	...
	<?php
$styleforbankingdetail="";
									if ($_SESSION['login_user_type'] == 'STUDENT') {

										$styleforbankingdetail="style='display:none'";
				...
				<div class="row">
					...
					<div class="page-content col-lg-8 col-md-8 col-sm-12 col-xs-12" ng-app="myApp" ng-controller="myCtrl" ng-cloak id="App2">
						<h3 align="center" ng-show="!userdetails">
							...
							<br />Loading <?php echo $_SESSION['login_user_type'];?> Profile Data..
							<br /><br /><br /><br />
						</h3>
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="cs-section-title">
										<h2> <?php echo $_SESSION['login_user_type'];?>  Profile Details</h2>
								...
								<form onsubmit="event.preventDefault();">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row">
												...
												<script>
													...
													// 		}
													// 	};
													// 	xhttp.open("GET", "<?php echo $server;?>insideapi.php?key=citylistHTMLWhenStateChange&state="+state, true);
													// 	xhttp.send();
													// }
													// }
													...
													// 		}
													// 	};
													// 	xhttp.open("GET", "<?php echo $server;?>insideapi.php?key=citylistHTMLWhenloadingpage", true);
													// 	xhttp.send();
													// }
													// getcitylistLoad();
												</script>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" <?php echo $styleforbankingdetail;?>>
									<div class="cs-section-title">
										<h2> <?php echo $_SESSION['login_user_type'];?>  Banking Details</h2>
									
									</div>
								</div>
								<div class="cs-field-holder" <?php echo $styleforbankingdetail;?>>
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="row">
	...
	app.controller('myCtrl', ['$scope', '$http', function($scope, $http) {
		...
		$scope.updateprofile = function() {
			...
			if ($scope.userdetails.first_name == '' || $scope.userdetails.first_name == undefined) {
				...
				$scope.showtoaster("WARNING");
				return false;
			} else if (login_user_type=='AFFILIATE' && ( $scope.userdetails.bank == '' || $scope.userdetails.bank == undefined)) {
				$scope.toastermessage = "Please fill Bank Name !";
				document.getElementById("bank").style.borderColor = 'red';
				$scope.showtoaster("WARNING");
				return false;
			} else if (login_user_type=='AFFILIATE' && ( $scope.userdetails.ifsc == '' || $scope.userdetails.ifsc == undefined)) {
				$scope.toastermessage = "Please fill IFSC Code !";
				document.getElementById("ifsc").style.borderColor = 'red';
				$scope.showtoaster("WARNING");
				return false;
			} else if (login_user_type=='AFFILIATE' && ( $scope.userdetails.accountnumber == '' || $scope.userdetails.accountnumber == undefined)) {
		...
		$scope.checkifitiscorrectstate = function() {
			...
			$http.get('<?php echo $server;?>insideapi.php?key=checkifitiscorrectstate&state=' + $scope.userdetails.state + '&city=' + $scope.userdetails.city).
		...
		$scope.actualworking = function() {
			...
			$http({
				...
				if (jsondata.data.status == 'SUCCESS') {
					$scope.toastermessage = "Your profile details updated successfully !!";
