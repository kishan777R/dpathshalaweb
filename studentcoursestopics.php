		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="cs-page-title">
					<h1 style="color:#fff !important;" id="kk2">
				...
				<div class="page-content col-lg-8 col-md-8 col-sm-12 col-xs-12" ng-app="myApp" ng-controller="myCtrl" ng-cloak id="App2">
					<div class="cs-user-content">
						...
						<div class="row" ng-repeat="key in arrayOfVideoTopicKey_id">
							...
							<?php
							$darr = explode("T", $_SESSION['studentdata']['course'][$_GET['i']]['starting_date']);
							$startingdate = $darr[0];
							...
							<ul class="cs-shortlisted">
								<li ng-repeat="obj in arrayOfVideoTopicKey[key]">
									<div class="cs-media">
										<figure><a href="studentcourseslectures?c={{courseobject.course_name}}&i={{user_course_index}}&vi={{obj._id}}">
												<img src="{{obj.serverpath+obj.imagepath}}" style="height: 100px" alt="" />
											</a></figure>
									</div>
									<div class="cs-text">
