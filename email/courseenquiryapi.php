...
header('Access-Control-Allow-Origin: *');
      ...
      extract( $_POST );
        ...
        $subjectq = "Subject Enquiry from Website from $name ";


         $message =  "<b>Subject :</b> $subject<br/><br/><b>Name :</b> $name<br/><br/><b>Message :</b> $message ";

 
     
           $mailresponse = maiServerl("kishanrock777@gmail.com", $subjectq, $message, $headers, []);

            if($mailresponse==1){
				 echo  json_encode(array("message"=>"Thank you for enquiring with us, we will contact you soon !","status"=>"TRUE"));
