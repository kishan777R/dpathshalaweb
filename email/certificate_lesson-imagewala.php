...
if ($action == "create") {
    ...
    $url = $urlOfInvoice =   "http://xcellinsindia.com/lesson/certificate_t-imagewala.php?" . 'data=' . $_id . '*' . $course_id . '*' . $sub_course_id . "*show*" . date('ymdhis');





    $apikey = "c98c52084f977625";
        ...
        try {
            ...
            switch ($json_data->status) {
                ...
                case "finished":
                    ...
                    $letterPDFcontentInvoice = file_get_contents($json_data->image_url);

                    call_p2i_with_callback($urlOfInvoice);
                    ///write
                    $r = $c_id_int . "_" . $courseIndex . ".jpeg";
