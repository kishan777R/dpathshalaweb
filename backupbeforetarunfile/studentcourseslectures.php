							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									...
									<div class="cs-main-post" ng-show="lectureobj.videopath!=''">
										<div class="cs-media">
											<video id="videoid" src="{{lectureobj.serverpath}}{{lectureobj.videopath}}" style="height: 300px;width:100%" controls controlsList='nodownload' onended="angular.element(this).scope().vidEnded()">
											</video>
									...
									<div class="cs-main-post" ng-show="lectureobj.supportpath!=''"> <br />
										<div class="cs-media">
											<a href="{{lectureobj.serverpath}}{{lectureobj.supportpath}}" target="_blank" download> <i class="icon-file-text2 cs-color"></i> Suppoting document</a>
										</div>
									</div>
									<br />
						...
						<aside class="page-sidebar col-lg-4 col-md-4 col-sm-12 col-xs-12">
							...
							<div class="widget widget-latest-news">
								...
								<ul ng-repeat="key in arrayOfVideoTopicKey_id">
									<li ng-repeat="obj in arrayOfVideoTopicKey[key]" ng-show="obj._id!=lectureobj._id">
						...
						$http({
							...
							if (res && res != null) {
								...
								if (!$scope.ansswerObj.answer) {
									$scope.toastermessage = "Waiting for answer of your question !";
									$scope.showtoaster('NORMAL');
