							...
							<div class="cs-field " style="float: right">
								<div class="cs-btn-submit">
									<span ng-show="orderlist.length>0 && orderlist[0].order_status=='SUCCESS'">
										...
										<input class="cs-bgcolor buttontypesubmit" style="float: right" type="button" onclick="window.location.href='courses'" value="&nbsp;+ Add more courses &nbsp;">

									</span>
									<span ng-show="orderlist.length>0 && orderlist[0].order_status=='FAIL'">

										 
										<input class="cs-bgcolor buttontypesubmit" style="float: right" type="button" onclick="window.location.href='checkout'" value="&nbsp;Try Again !&nbsp;">
